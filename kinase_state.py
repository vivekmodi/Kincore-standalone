...
def identify_state(pwd,pdbfilename,align,user_model,user_chain,user_lys,user_glu,user_phe):
    ...
    if align.upper()=='FALSE':
        ...
        for chains in list(user_chain.split(',')):
            conf_df.at[index,'Chain_id']=chains
...
if __name__ == '__main__':
    ...
    parser.add_argument('Align',help='True/False; If "True" then the program will align the input protein sequence to pre-computed HMMs and identify conserved \
                        ...
                        If "False" then the please provide the optional arguments (Example $python kinase_state.py --Model 0 --Chain A,B,C --Lys 1030 --Glu 1047 --Phe 1151 1GAG.pdb False)')
    ...
    parser.add_argument('-M','--Model',help='Model id of the protein kinase structure in the input file, if the file does not contain any Model id then specify 0')
