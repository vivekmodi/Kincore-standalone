...
def spatial_label(index,conf_df):
    ...
    if dis_phe_rre4<=11 and dis_phe_lys>=11 and dis_phe_rre4!=99999 and dis_phe_lys!=99999:
        conf_df.at[index,'Spatial_label']='DFGin'
        
    if dis_phe_rre4>11 and dis_phe_lys<=14 and dis_phe_rre4!=99999 and dis_phe_lys!=99999:
